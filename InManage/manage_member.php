    ...
    <div class="body-member">
        <div class="member-view">
            <table class="table table-bordered">
                ...
                // นับจำนวนแถวทั้งหมดในตาราง member
                $total_rows = mysqli_num_rows($result);

                // คำนวณจำนวนหน้าทั้งหมด
                $total_pages = ceil($total_rows / $limit);

                mysqli_data_seek($result, $start); // เลื่อน pointer ให้ชี้ที่แถวเริ่มต้นของหน้าที่เราต้องการ
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>" . $row['Membername'] . ' ' . $row['Memberlastname'] . "</td>"; // แสดงชื่อและนามสกุลของสมาชิก
