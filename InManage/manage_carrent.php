...
<header>
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="dropdown">
                <button class="btn btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton"
...
<div class="body-carrent">
    ...
    <div class="table-view-carrent">
        <table class="table table-bordered ">
            ...
            $whereClause = "WHERE carrent.carrent_status IN ('กำลังดำเนินการเช่า', 'ดำเนินการเช่าเสร็จสิ้น')";
            if (!empty($_GET['start_date'])) {
                $startDate = $_GET['start_date'];
                $whereClause .= " AND carrent.carrent_date = '$startDate'";
            }

            if (!empty($_GET['carrent_status'])) {
                $statusId = $_GET['carrent_status'];
            ...
            $countSql = "SELECT COUNT(*) AS total FROM carrent
            ...
            <ul class="pagination">
                <?php for ($i = 1; $i <= $pages; $i++) : ?>
                    <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                        <a class="page-link"
                           href="?page=<?php echo $i; ?>&start_date=<?php echo isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>&carrent_status_id=<?php echo isset($_GET['carrent_status_id']) ? $_GET['carrent_status_id'] : ''; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
            </ul>
        </nav>
