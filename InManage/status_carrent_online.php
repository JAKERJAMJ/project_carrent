...
$sql_payment = "SELECT * FROM payment WHERE carrent_id = $id";
...
<head>
    ...
    <link rel="stylesheet" href="../styles/status_carrent_online.css">
...
<body>
    ...
    <div class="member-detail">
        <div class="detail">
            ...
            <div class="detail-body">
                <form action="status_carrent_online.php?id=<?= $row['carrent_id'] ?>" method="post" id="statusForm">
                    <div class="box">
            ...
            <div class="status-container" id="statusContainer" style="display: <?= $is_status_1 ? 'block' : 'none'; ?>;">
                ...
                <div class="payment">
                    <?php if (!empty($Member['payment_slip'])) : ?>
                        <img src="../img/slip/<?= $Member['payment_slip'] ?>" class="slip" alt="PaymentSlip">
                    <?php else : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="confirmReceiveCarForm" action="status_carrent_online.php?id=<?= $row['carrent_id'] ?>" method="post" style="display: none;">
        ...
        <table class="table">
            ...
            while ($row_payment = mysqli_fetch_assoc($result_payments)) {
                ...
                if ($row_payment['type_rent'] == 'เช่ารถหน้าร้าน') {
                    ...
                    echo "<td>" . (!empty($row_payment['payment_slip']) ? '<a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="../img/slip/' . $Member['payment_slip'] . '">ดูหลักฐาน</a>' : 'ไม่มี') . "</td>";
                }
    ...
    <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="imageModalLabel">หลักฐานการชำระเงิน</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <img src="" id="paymentImage" class="img-fluid" alt="Payment Slip">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="paymentConfirmModal" tabindex="-1" aria-labelledby="paymentConfirmModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="confirmPaymentForm" action="status_carrent_online.php?id=<?= $row['carrent_id'] ?>" method="post" style="display: none;">
    ...
    <div class="modal fade" id="ReturnCarModal" tabindex="-1" aria-labelledby="ReturnCarModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="status_carrent_online.php?id=<?= htmlspecialchars($row['carrent_id']) ?>" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
